...
func TestVagrantStageOptionsSyncedFolders(t *testing.T) {
	...
	stageOptions.SyncedFolders = make(map[string]*VagrantSyncedFolderStageOptions)
	stageOptions.SyncedFolders["/vagrant"] = &VagrantSyncedFolderStageOptions{
...
func TestVagrantStageOptionsSyncedFoldersNoVirtualbox(t *testing.T) {
	...
	assert.Error(t, stageOptions.validate())
}
