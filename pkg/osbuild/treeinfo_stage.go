...
type TreeinfoData struct {
	...
	Images   map[string]map[string]string           `json:"images,omitempty"`   // images compatible with particular $platform - serialized as "images-<arch>"
	Variants map[string]TreeinfoVariantStageOptions `json:"variants,omitempty"` // serialized as "variant-<uid>"
