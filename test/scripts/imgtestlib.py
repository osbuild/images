...
def gen_build_info_s3_dir_path(osbuild_ref, runner_distro, distro, arch, manifest_id):
    """
    ...
    """
    build_info_prefix = os.path.join(
        S3_BUCKET, S3_PREFIX, f"osbuild-ref-{osbuild_ref}", f"runner-{runner_distro}", distro, arch)
